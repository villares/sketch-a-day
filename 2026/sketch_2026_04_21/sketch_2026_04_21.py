...
#     Segment(550, 50, 550, 550, static=True)
    ...
    sb = Segment(400, 100, 400, 200, fill_color=255, radius=20)
    sc = Segment(400, 200, 300, 200, fill_color=255, radius=20)
    PivotJoint(sa, sim.static_body, (300, 100), color=py5.color(255, 0, 0))
    PivotJoint(sa, sb, (400, 100))
    PivotJoint(sb, sc, (400, 200))
...
def key_pressed():
    ...
    if py5.key in (py5.BACKSPACE, py5.DELETE):
        ...
        add_soft_grid(py5.mouse_x, py5.mouse_y, 5, 20, 20)
