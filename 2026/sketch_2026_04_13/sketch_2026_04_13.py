...
def setup():
    ...
    outer = shapely.Polygon(star_points(450, 300, 100, 150, 10, rot=py5.HALF_PI))
    inner = shapely.Polygon(star_points(450, 300, 150, 50, 10, rot=py5.HALF_PI + py5.PI / 10 ))
    star = Poly(outer-inner)
    p = PivotJoint(star, star.static_body, (450, 300))
    p.visible = False
    
    five = polys_from_text('5', py5.create_font('Tomorrow Bold', 350))[0]
    five = shapely.affinity.translate(five, 50, 430)
    f = Poly(five, kinematic=True)
    #f = PivotJoint(star, star.static_body, (450, 300))
