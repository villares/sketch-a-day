...
def setup():
    ...
    sa = Slider(0, 360, 15, label='A')
    sb = Slider(0, 360, 22, label='B')
...
def draw():
    ...
    desenha_frase(200, 500, frase_a, angulo=sa.value, passo=5)
    desenha_frase(300, 700, frase_a, angulo=sa.value * 2, passo=5)
    desenha_frase(600, 700, frase_b, angulo=sb.value, passo=1)
    Slider.update_all()
