...
Hi! I'm [Alexandre](https://abav.lugaralgum.com), welcome! With this ongoing project I try to make one small program (*sketch*) a day, and I usually put the code on the same repository that stores this page, [github.com/villares/sketch-a-day](https://github.com/villares/sketch-a-day).

The results are mostly tentative, exploratory, and I don't feel like they need to be relevant or meaningful for any particular day, but they do give rise to ideas that I consider interesting or worthy of further exploration, like those I've put at [selected work](https://abav.lugaralgum.com/selected-work/index-EN.html), and this collection became "an interesting thing" in itself. 
