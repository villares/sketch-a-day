...
def setup():
    ...
    easing = (
        ...
        SineInOut, QuadraticEaseInOut, CubicEaseInOut, ExponentialInOut,
...
def draw():
    ...
    x = (2 * frameCount) % height + 3
    t = map(x, 0, height, 0, 1)
