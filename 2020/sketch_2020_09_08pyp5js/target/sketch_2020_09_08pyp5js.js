// Transcrypt'ed from Python, 2020-09-08 19:38:52
...
var __name__ = 'sketch_2020_09_08pyp5js';
...
export var draw = function () {
	...
	grid (width / 2, height / 2, tuple ([8, 4]), 150 * sf, ensamble, 5);
	if (checkbox.value && __mod__ (frameCount, 60) == 0) {
		shuffle (gliphs);
	}
};
...
export var cb_changed = function () {
	if (arguments.length) {
		var __ilastarg0__ = arguments.length - 1;
		if (arguments [__ilastarg0__] && arguments [__ilastarg0__].hasOwnProperty ("__kwargtrans__")) {
			var __allkwargs0__ = arguments [__ilastarg0__--];
...
//# sourceMappingURL=sketch_2020_09_08pyp5js.map