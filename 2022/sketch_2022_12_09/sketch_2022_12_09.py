...
from villares.arcs import arc_augmented_poly as afp
...
def draw():
    ...
    for i, pts in enumerate(polys):
        if pts:
            cor = color((128 + (i // 24) * 16) % 255, 250, 100)
            no_fill()
            stroke(100, 100)
            stroke_weight(10)
            draw_poly(pts)
