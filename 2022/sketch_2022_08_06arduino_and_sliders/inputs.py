...
class InputInterface:
    ...
    def __init__(self, port=None):
        ...
        if self.source is None:
            ...
            # start, end, default
            A = Slider(0, 1023, 512, ('a', 'd'))
            B = Slider(0, 1023, 512, ('s', 'w'))
            C = Slider(0, 1023, 512, (py5.LEFT, py5.RIGHT))
            D = Slider(0, 1023, 512, (py5.DOWN, py5.UP))
            A.position(40, h - 70)
            B.position(40, h - 30)
...
class Slider:
    ...
    def __init__(self, low, high, default, control_keys):
    ...
    def position(self, x, y):
        ...
        self.rectx = self.x + py5.remap(self.val, self.low, self.high, 0, S_WIDTH)
    ...
    def update(self):
        ...
        if up in self.keys_pressed:
            self.rectx += 1
        # constrain rectangle
        self.rectx = py5.constrain(self.rectx, self.x, self.x + S_WIDTH)
        # draw rectangle
        py5.no_stroke()
        py5.fill(255)
        py5.rect(
