// Transcrypt'ed from Python, 2019-07-02 22:28:15
...
export var Point =  __class__ ('Point', [object], {
	__module__: __name__,
	grid: dict (),
	nbr: tuple ([tuple ([-(1), 0]), tuple ([1, 0]), tuple ([0, -(1)]), tuple ([0, 1])]),
	...
	get place () {return __get__ (this, function (self) {
		...
		var __left0__ = tuple ([self.i * self.space, self.j * self.space]);
		var x = __left0__ [0];
		var y = __left0__ [1];
		var __left0__ = tuple ([mouseX - width / 2, mouseY - height / 2]);
		var mx = __left0__ [0];
		var my = __left0__ [1];
		var a = self.space / sqrt (1 + dist (x, y, mx, my) / 100);
		return tuple ([self.i * a, self.j * a]);
	});},
