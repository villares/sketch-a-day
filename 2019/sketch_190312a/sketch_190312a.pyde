...
def draw():
    ...
    a_list = [(a.p1.x, a.p1.y, a.p1.r, a.p1.cor,
               a.p2.x, a.p2.y, a.p2.r, a.p2.cor) for a in Aresta.ARESTAS]
    history.append(a_list)

    for i, layer in enumerate(history):
        translate(0, 0, -10)
        for p1x, p1y, p1r, p1c, p2x, p2y, p2r, p2c in layer:
            fill(lerpColor(p1c, p2c, 0.5))
            translate(0, 0, -1)
            var_bar( p1x, p1y, p2x, p2y, p1r, p2r)
