...
def draw():
    ...
    for i, (xa, ya, za) in enumerate(points):
        ...
        # fill(0)
        text_line(linhas[i], xa, ya, za, xb, yb, i * 10) #,zb)
...
sumario = u"""
 ...
 negritude, desvalorizada em seu protagonismo; e o da memória da cidade de São
 Paulo, esquecida na acelerada urbanização.
...
Ouvir Geraldo Filme é transportar-se para o tempo do samba batido com latão de
 lixo e caixa de engraxate no extinto Largo da Banana, na Barra Funda. São
 cenários vivamente construídos onde enxerga-se o drama dos negros, diplomados
...
O novo lançamento do Selo, Tio Gê – O samba paulista de Geraldo Filme, traz toda a
 ...
 maneira a mostrar ao público o desenvolvimento da carreira do sambista. O
 projeto, idealizado por Fernando Cardoso, traz 20 composições de Geraldo Filme,
