...
def generate():
    global circles
    circles = []
    for x, y in product(range(-260, 261, 40), repeat=2):
        circles.append(Circle(x, y, 40))


class Circle:

    def __init__(self, x, y, size_,):
        self.x = x
        self.y = y
        self.ix = x
        self.iy = y
    ...
    def update(self):
        ...
        self.x = lerp(self.x, self.ix, 0.19)
        self.y = lerp(self.y, self.iy, 0.19)
