...
left_col = [
    [sg.Text('Folder'), sg.In(size=(25, 1), default_text=cwd, enable_events=True ,key='-FOLDER-'),
...
window = sg.Window('Multiple Format Image Viewer', layout,resizable=True, font='Consolas 10')
