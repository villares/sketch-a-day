...
def draw():
    ...
    if ret:
        ...
        gray = 255 - cv2.cvtColor(resized_frame, cv2.COLOR_BGR2GRAY)

        tresholds = (
            cv2.threshold(gray, 150, 255, cv2.THRESH_BINARY)[1],  # ret, img
...
#             x += 400
        colors = (py5.color(255, 100), py5.color(200, 100), py5.color(100, 100))
