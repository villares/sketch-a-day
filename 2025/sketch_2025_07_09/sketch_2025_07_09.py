...
def make_simple_poly(grid, grid_pts= 6):
    simple = False
    while not simple:
        poly = LinearRing(py5.random_sample(grid, grid_pts)).buffer(32, cap_style='round', join_style='round').exterior
    ...
    for z in range(-Z_OFFSET + 20, Z_OFFSET, 20):
        ...
        with py5.push_matrix():
            ...
            with py5.begin_closed_shape():
                py5.vertices(py5.lerp(np.array(points_a), np.array(points_b), t))
