...
#     line(0, r + d, d, r - d)
    ...
    #circle(d + d / 2.0, w / 2.0, d * 2)
    #circle(d + d / 2.0, w / 2.0, d * 3)
    line(r, r - q, 2.0 * q - d, r - q)
    circle(d + d / 2.0, w / 2.0 - q, d)
    #circle(d + d / 2.0, w / 2.0 - q, d * 2)
    #circle(d + d / 2.0, w / 2.0 - q, d * 3)
    line(r, w, r, w - d)
    circle(w / 2.0, w - (d + d / 2.0), d)
    #circle(w / 2.0, w - (d + d / 2.0), d + d)
    #circle(w / 2.0, w - (d + d / 2.0), d + d + d)
