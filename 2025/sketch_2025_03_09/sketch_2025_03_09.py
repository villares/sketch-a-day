...
def setup():
    ...
    for x in range(0, 1000, 20):
        for y in range(0, 1000, 15):
            img.stroke(y / 4,
                       255 - y / 4,
                       128 + py5.random(-128, 128), 128)
            img.line(0, y + py5.random(-15, 15),
                     1000, y + py5.random(-15, 15))
            img.stroke(128 + py5.random(-128, 128),
                       x / 4, 255 - x / 4, 128)
            img.line(x + py5.random(-15, 15), 0,
                     x + py5.random(-15, 15), 1000)
    img.end_draw()
    py5.no_loop()
