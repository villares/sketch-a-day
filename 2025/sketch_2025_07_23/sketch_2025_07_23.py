...
N = 8
FW = 12  # first stroke weight
SW = 12  # second weight
first_color = color(255, 100)
second_color = color(0, 100, 0, 100)
bgd = color(150, 150, 200)
...
def module0(w):
    ...
    stroke(second_color)
    stroke_weight(SW)
    quarter_circle(0, w, r, TOP + RIGHT)
    quarter_circle(w, 0, r, BOTTOM + LEFT)
